...
from WWWL5 import StartTime, jmthonversion, WWWL5
...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**سورس القائد يعمل بنجاح**"
...
ROZ_T = (
    f"**⌯︙بوت القائد يعمل بنجاح 🤍،**\n"
    f"**   - اصدار التليثون :** `1.23.0\n`"
    f"**   - اصدار القائد :** `4.0.0`\n"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("السورس") and event.query.user_id == WWWL5.uid:
            buttons = [
                [
                    Button.url("قنـاة السـورس ⚙️", "https://t.me/V_P_N_8"),
                    Button.url("مطور السورس 👨🏼‍💻", "https://t.me/Z_X_Z_B"),
                ]
            ]
