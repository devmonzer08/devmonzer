...
async def bot_start(event):
    ...
    custompic = gvarstatus("BOT_START_PIC") or "https://telegra.ph/file/ba5e50feaff3c2bbde984.jpg"
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("• السورس •", "https://t.me/V_P_N_8"),
                Button.url(
                    "• المطور •",
                    "https://t.me/Z_X_Z_B",
                ),
