...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر القائد
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == WWWL5.uid:
            buttons = [
                [Button.inline("معلومات القائد", data="AOMRDB")],
                [
...
اوامر فارات سورس القائد @Help_Tele_Leader""",
        buttons=[
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس القائد هذه بعض المعلومات عن القائد :

- سورس القائد يمتلك اكثر من 100 أمر 
- القائد هو افضل سورس عربي يتميز بالحماية

قـنـاة الـكـلايــش: @Source_Monzer
قـنـاة الشروحات: @Help_Tele_Leader
قـنـاة الـســورس: @Help_Tele_Leader
قناة الـمـسـاعـدة: @V_P_N_8
جروب المساعدة: @Help_Leader""",
        buttons=[
            [Button.inline("رجوع", data="namevar")],
        ],
    )
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @Source_Monzer
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس القائد @Help_Tele_Leader""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
...
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات القائد @Help_Tele_Leader""",
        buttons=[
            [Button.inline("رجوع", data="alivevar")],
        ],
    )
