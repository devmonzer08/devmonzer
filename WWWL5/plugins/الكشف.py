...
from WWWL5.core.managers import edit_or_reply, edit_delete
from WWWL5.helpers import reply_id
from WWWL5.sql_helper.globals import gvarstatus
from WWWL5.plugins import spamwatch
...
async def fetch_info(replied_user, event):
    ...
    rozrtba = (
        ".「  مـطـور آلُِسورس 𓄂𓆃 」."
        if user_id == 5593884330 or user_id == 5578760481 or user_id == 6650021309 or user_id == 5989301475 or user_id == 525601 or user_id == 183303
        else (".「  العضـو 𓅫 」.")
    )
    rozrtba = (
        ".「 مـالك الحساب  」."
    ...
    caption = " ╮•⎚ مـعلومات الـشخص مـن بـوت القائد\n"
    caption += f"✛┈┉━｢ ᥉᥆υᖇᥴᥱ LEᗩᗪEᖇ . ✰ ｣━┅┈✛\n"
...
@WWWL5.ar_cmd(pattern="رابط الحساب(?:\s|$)([\s\S]*)")
