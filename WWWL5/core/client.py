        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                if hasattr(chat, "title"):
                    if (
                        ...
                        await check.client.send_message(
                            "@V_P_N_8", "اهلا منذر استخدامي ما يناسب القائد"
                        )
                        return
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[هنا](https://t.me/Help_Leader)"
                        text = "**تقرير خطأ سورس القائد**\n\n" + "اذا اردت يمكنك التبليغ"
            ...
            if pattern is not None:
                ...
                if edited:
                    WWWL5.add_event_handler(func, events.MessageEdited(**kwargs))
                WWWL5.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                WWWL5.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                WWWL5.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
